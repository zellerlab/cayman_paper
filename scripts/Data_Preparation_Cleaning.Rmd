...
## Here remove the timepoinst of individuals sampled twice and also only retain adults and seniors (so 18+)
repeated_samples_to_remove_Rosa <- complete_western_non_western_metadata %>% filter(!(study_name == "RosaBA_2018" & days_from_first_collection == 0 | country == "LBR")) %>% filter(study_name == "RosaBA_2018")
repeated_samples_to_remove_Pehrsson <- complete_western_non_western_metadata %>% filter(study_name == "PehrssonE_2016" & days_from_first_collection != 0) %>% filter(study_name == "PehrssonE_2016")

samples_to_be_removed <- rbind(repeated_samples_to_remove_Rosa, repeated_samples_to_remove_Pehrsson)
complete_western_non_western_metadata <- complete_western_non_western_metadata %>% filter(sample_id %nin% samples_to_be_removed$sample_id) %>% filter(age_category == "adult" | age_category == "senior")

## Now add info on sample numbers per study
...
complete_western_non_western_metadata$study_name_W_NW_info_n <- factor(complete_western_non_western_metadata$study_name_W_NW_info_n, levels = c("BritoIL_2016 (n=154)", "KaurK_2020 (n=30)", "LiuW_2016_NW (n=65)", "LokmerA_2019 (n=57)","Obregon-TitoAJ_2015_NW (n=17)","PasolliE_2019 (n=111)","PehrssonE_2016 (n=57)","RampelliS_2015_NW (n=22)","RosaBA_2018 (n=14)","RubelMA_2020 (n=153)","SmitsSA_2017 (n=31)","TettAJ_2019_a (n=36)","TettAJ_2019_b (n=23)","TettAJ_2019_c (n=24)", "AsnicarF_2021 (n=1096)", "HMP_2012 (n=93)", "LiuW_2016_W (n=45)", "Obregon-TitoAJ_2015_W (n=19)", "QinJ_2012 (n=173)", "RampelliS_2015_W (n=11)", "SchirmerM_2016 (n=456)", "XieH_2016 (n=169)", "YachidaS_2019 (n=246)", "ZeeviD_2015 (n=858)"))
...
#saveRDS(complete_western_non_western_rel_abundances_wide_filtered_samples, here("data", "Intermediate_Files", "20240809_complete_western_non_western_rel_abundances_wide.rds"))
...
meta_CRC <- meta_CRC %>% dplyr::rename("SampleID" = Sample_ID)
...
CRC_df_list_rel_abun_long_merged <- CRC_df_list_rel_abun_long_merged %>% mutate(Run = coalesce(Run, SampleID)) %>% select(-SampleID) %>% dplyr::rename("SampleID" = Run)
...
completed_substrate_annotations <- read_xlsx(here("data", "Glycan_Annotations", "20250219_Table_S1_incl_dbCAN3_annotations.xlsx")) ## Had to manually add the GT, CE and AA families to Omar's latest file.
