...
permutest(betadisper_test) ##Means we cannot reject that the groups have the same dispersions, so this gives us higher confidence that adonis results are real
set.seed(1000) ## To ensure reproducible results
...
Extended_Data_Fig2 <- pcoa_plot_study_colored_bray +

ggsave(here("../figures/Extended_Data_Fig2.pdf"), Extended_Data_Fig2, width = 120, height = 75, unit = "mm")
