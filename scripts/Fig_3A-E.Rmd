...
## Fig 3A 
```{r}
metadata_perm <- meta(westernized_non_westernized_ps)
...
write_tsv(CAZyme_count_df, here("data", "Intermediate_Files", "20230929_CAZyme_count_df.tsv"))
